...
1) Regarding these "resolutions":
    ```json
        "@types/react": "17.0.2",
        "@types/react-dom": "17.0.2"
    ```
    This is due to [this issue](https://github.com/facebook/react/issues/24304) and the resolution is as described 
[here](https://stackoverflow.com/a/71828113).
