...
export SERVICE_DIR=
export SERVICE_TAG=codefresh
export SERVICE_VERSION=0.0.1
export SERVICE_REQUIREMENTS_TXT=requirements.txt
...
function create_git_creds_requirements() {
    ...
    EPHEMERAL_LEAF_SOURCE_CREDENTIALS="x-access-token:${EPHEMERAL_TOKEN}"
    sed -i "s/\${LEAF_PRIVATE_SOURCE_CREDENTIALS}/${EPHEMERAL_LEAF_SOURCE_CREDENTIALS}/g" ${WITH_CREDS_REQUIREMENTS}
